...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">　
    ...
    <tr>
        <td>
            <div style="margin: 20px;text-align: center;margin-top: 50px;border-bottom: solid 1px gray">
	...
	<tr>
		<td>
			<div style="border: #36649d 1px dashed;margin: 30px;padding: 20px">
				...
				<p style="font-size: 16px">亲爱的&nbsp;
					<label style="font-weight: bold">XXX先生/女士</label>&nbsp; 您好！欢迎加入xxx。
				</p>
